...
std::string BTruckers::Server::Commands::Handler(BTruckers::Shared::Structures::Message& message, BTruckers::Server::Core::DBHandler* db)
{
    ...
    switch(crcValue)
    {
        ...
        case BTruckers::Server::Enums::CommandsCRC::REGISTER:
            response = BTruckers::Server::Commands::Handle::Register(db, message.payload);
            break;
        ...
        case BTruckers::Server::Enums::CommandsCRC::GETSETTINGS:
            response = BTruckers::Server::Commands::Handle::GetSettings(db, &user,message.payload);
            break;
